...
function AudioList() {
    ...
    const [img, setIamge] = useState(Songs[0].imgSrc);
  ...
  return (
    <div className='audioList'>
        <h2 className='title'>The list <span>{Songs.length}</span> <span>songs</span></h2>
        ...
        <div className='songsContainer'>

            {
                Songs && Songs.map((song, index) => (
                    ...
                    <div className='count'><span>#</span>{index + 1}</div>
                    <div className='song'>
